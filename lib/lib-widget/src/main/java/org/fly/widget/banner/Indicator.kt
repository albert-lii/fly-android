...
open class Indicator : View {
    ...
    private fun init(attrs: AttributeSet?) {
        attrs?.let {
            val typedArray = context.obtainStyledAttributes(attrs, R.styleable.fly_Indicator)
            activeColor =
                typedArray.getColor(R.styleable.fly_Indicator_indicator_activeColor, activeColor)
            inactiveColor = typedArray.getColor(
                R.styleable.fly_Indicator_indicator_inactiveColor,
                inactiveColor
            )
            inactiveScale = typedArray.getFloat(
                R.styleable.fly_Indicator_indicator_inactiveScale,
                inactiveScale
            )
            gap = typedArray.getDimension(R.styleable.fly_Indicator_indicator_gap, gap)
            typedArray.recycle()
        }
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        val newWidthMeasureSpec = measureWidth(widthMeasureSpec, totalWidth.toInt())
