...
import fly.mod.test.databinding.StActivityLivebusTest1Binding
import fly.mod.test.livebus.Constants
import fly.mod.test.livebus.viewmodel.LiveBusTest1ViewModel
    ...
    private fun addListener() {
        binding.btnPost.singleClick {
            ...
            RouterUtils.getInstance()
                .navigation(this@LiveBusTest1Activity, RouteConstants.PAGE_ST_LIVEBUS_TEST2)
        }
    }
